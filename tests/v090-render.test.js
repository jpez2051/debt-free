...
test('all main pages render migrated financial data through the final build pipeline',async()=>{
  ...
  try{
    for(const [route,text] of [['dashboard','Cash after tracked obligations'],['accounts','Reconcile balance'],['transactions','Log refund'],['bills','Bill occurrences'],['debts','Statements'],['payoff','no new charges or fees'],['spending','Net spending by category'],['insights','Current credit scores']]){
