...
import { transformAppV059 } from './scripts/v059-app-transform.js'
...
export default defineConfig({
  ...
  plugins: [{
    ...
    transform(code, id) {
      ...
      return transformAppV059(transformAppV058(transformAppV057(transformAppV056(transformAppV055(transformAppV054(code))))))
    },
  }],
})
